...
import traceback
from modules.CharMap import charmap
...
def logger(msg,source='NONE',severity='INFO',sameline=False,logFilePath=os.path.join(UTILSDIR,"log.txt")):  
